...
global.modules = (module) => {
	let modules = {
		route: {
			...
			bill: require(`${process.cwd()}/routes/bill.route`),
		},
		middleware: {
			...
			bill: require(`${process.cwd()}/controllers/bill/bill.middleware`),
		},
		controller: {
			...
			bill: require(`${process.cwd()}/controllers/bill/bill.controller`),
		},
	}
